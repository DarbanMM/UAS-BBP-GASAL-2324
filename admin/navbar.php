...
$base_url = "http://localhost/portal_berita/" 
?>
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
	<div class="container">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?= $base_url ?>index.php">Lihat Website</a>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="<?= $base_url ?>admin/siswa/index.php">Data Kontributor</a>
