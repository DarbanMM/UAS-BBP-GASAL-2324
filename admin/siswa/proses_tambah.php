...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_siswa (nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_hp, foto) VALUES('$nama', '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$no_hp', '$nama_foto')") or die(mysqli_error($koneksi));
